...
$(document).ready(function(){      
    ...
    function init_template(){        
        ...
        if($('#footer-menu').length){
            $('.page-content').css('padding-bottom','10px');
        }
        ...
        if (!readCookie('enabled_cookie_themeforest_101')) {
       ...
       $(".text-size-default").click(function() {$(".text-size-changer *").css("font-size", "");});
        ...
        setTimeout(function(){
            ...
            $('.cover-slider').owlCarousel({loop:false, margin:0, nav:true, lazyLoad:true, items:1, autoplay: true, autoplayTimeout:2000,navText: ["BACK","NEXT"]});        
        ...
        $('input, .input-required input, .input-required select, .input-required textarea').on('focusin',function(){
        ...
        function highlight_colors(){
            ...
            if (data.indexOf(bodyColor) > -1) {
                ...
                var highlightBorder = '.preloader div, .border-highlight{border-color:'+highlightColorCode+'!important}'
